...
{
    [ViewDefinition("ClockAndVolume.Views.basic-clock-preview.bsml")]
    [HotReload(RelativePathToLayout = @"..\Views\basic-clock-preview.bsml")]
    public class BasicClockViewPreview : BSMLAutomaticViewController, IInitializable
    {
