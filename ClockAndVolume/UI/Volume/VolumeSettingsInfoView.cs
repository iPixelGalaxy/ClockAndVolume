...
namespace ClockAndVolume.UI.Volume
{
    [ViewDefinition("ClockAndVolume.Views.volume-settings-info-view.bsml")]
    [HotReload(RelativePathToLayout = @"..\..\Views\volume-settings-info-view.bsml")]
